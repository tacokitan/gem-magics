...
public class JumpBoostGemPlayerFinishesUsingItemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (GemMagicsModParticleTypes.HASTE_PARTICLE), x, y, z, 6, 0.5, 1, 0.5, 1);
		}
	}
}
