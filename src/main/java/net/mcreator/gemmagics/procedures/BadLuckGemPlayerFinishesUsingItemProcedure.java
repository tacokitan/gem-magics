...
public class BadLuckGemPlayerFinishesUsingItemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MobEffects.UNLUCK, 300, 1));
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (GemMagicsModParticleTypes.BAD_LUCK_PARTICLE), x, y, z, 6, 0.5, 1, 0.5, 1);
		}
	}
}
