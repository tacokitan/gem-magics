...
public class HasteGemPlayerFinishesUsingItemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (GemMagicsModParticleTypes.DELETED_MOD_ELEMENT), x, y, z, 6, 0.5, 1, 0.5, 1);
		}
	}
}
