...
import net.mcreator.gemmagics.procedures.PoisonGemPlayerFinishesUsingItemProcedure;
...
public class PoisonGemItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Exudes a debilitating aura of affliction."));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		PoisonGemPlayerFinishesUsingItemProcedure.execute(world, x, y, z, entity);
		return retval;
	}
}
