...
import net.mcreator.gemmagics.procedures.InstantHealthGemPlayerFinishesUsingItemProcedure;
...
public class InstantHealthGemItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Pulses with a revitalizing life force."));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		InstantHealthGemPlayerFinishesUsingItemProcedure.execute(world, x, y, z, entity);
		return retval;
	}
}
