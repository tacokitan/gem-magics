...
import net.mcreator.gemmagics.procedures.InstantDamageGemPlayerFinishesUsingItemProcedure;
...
public class InstantDamageGemItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Unleashes instantaneous destructive force."));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		InstantDamageGemPlayerFinishesUsingItemProcedure.execute(world, x, y, z, entity);
		return retval;
	}
}
