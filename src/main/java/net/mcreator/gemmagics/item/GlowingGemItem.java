...
import net.mcreator.gemmagics.procedures.GlowingGemPlayerFinishesUsingItemProcedure;
...
public class GlowingGemItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Flowers with a radiant luminescence."));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		GlowingGemPlayerFinishesUsingItemProcedure.execute(world, x, y, z, entity);
		return retval;
	}
}
